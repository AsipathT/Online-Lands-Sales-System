			...
			<legend>Payment</legend>
				...
				<form method="post" action="userpayment.php">
					...
					<div class="c-details">
						<div>
							<p>Expiry date</p>
							<input type="text" name="e_date" class="cc-exp" placeholder="MM/YY" required maxlength="5" required>
						</div>
						<div>
							<p>CVV</p>
							<div class="cvv-box" id="cvv-box">
								<input type="text" name="cvv" class="cc-cvv" placeholder="CVV" required maxlength="3" required>
